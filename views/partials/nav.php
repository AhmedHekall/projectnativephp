        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/" aria-current="page" class="<?= urlIs('/') ? "bg-gray-900 text-white":"bg-gray-700" ?>  hover:bg-gray-700 px-3 ">Home</a>
              <a href="/about"  class="<?=   urlIs('/about')? "bg-gray-900 text-white":"bg-gray-700" ?>  hover:bg-gray-700 px-3 ">Aboute</a>
              <a href="/notes"  class="<?=   urlIs('/notes')? "bg-gray-900 text-white":"bg-gray-700" ?>  hover:bg-gray-700 px-3 ">notes</a>
              <a href="/contact"  class="<?= urlIs('/contact') ? "bg-gray-900 text-white":"bg-gray-700" ?>  hover:bg-gray-700 px-3 ">Contact</a>
          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <el-dropdown class="relative ml-3">
              <?php if(isset($_SESSION['user_id'])):?>
               ...
               <a href="/logout" aria-current="page" class="<?= urlIs('/login') ? "bg-gray-900 text-white":"bg-gray-700" ?>  hover:bg-gray-700 px-3 ">logout</a>
              <?php else : ?>
               <a href="/login" aria-current="page" class="<?= urlIs('/login') ? "bg-gray-900 text-white":"bg-gray-700" ?>  hover:bg-gray-700 px-3 ">Login</a>

               <?php endif ?>
              <a href="/register" aria-current="page" class="<?= urlIs('/rigester') ? "bg-gray-900 text-white":"bg-gray-700" ?>  hover:bg-gray-700 px-3 ">Rigester</a>
